...
import appLogo from "../../Images/tastyTraverse.png";
...
const Title = () => (
  <a href="/">
    <img className="logo" src={appLogo} alt="Tasty Traverse Logo" />
  </a>
);
...
const Footer = () => {
  return (
    <div className="footer">
      Created By
      <i></i>
      <a href="https://www.linkedin.com/in/faris-shariff-05/" target="_blank">
        Faris Mohammed Shariff
      </a>
      <i></i>2023
      <strong>
        TastyTraverse
